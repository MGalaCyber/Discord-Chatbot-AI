module.exports.run = async(client, message, args) => {
    ...
    .setColor('RANDOM')
    .addField('Click here for invite!', `🔗: [Invite bot](https://discord.com/oauth2/authorize?client_id=${client.user.id}&permissions=533583101136&redirect_uri=https%3A%2F%2Fsiesta-chan.vercel.app&response_type=code&scope=identify%20email%20guilds%20bot)`, true)
