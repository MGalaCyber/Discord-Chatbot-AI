module.exports.run = async(client, message, args) => {
    ...
    .addField('🔗: [Invite bot](https://discord.com/api/oauth2/authorize?client_id=869755197046530060&permissions=515466853952&scope=bot)', 'Click here for invite!')
    .addField('🔗: [Join Discord Server](https://discord.gg/invite/VzGNhtmmfB)', 'Click here for Join to My Discord Server!')
