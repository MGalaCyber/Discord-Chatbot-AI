...
// ======================================== Limit code here ======================================= \\
    ...
    .setColor('#00ff00')
    .setTitle(`✅ Successfully remove blacklisted ${user.tag}!`)
    ...
    module.exports.config = {
      name: 'removeblacklist-user',
      aliases: ['rbl-user', 'rblsuser', 'removeblacklistuser'],
      usage: 'removeblacklist-user <user>'
    }
